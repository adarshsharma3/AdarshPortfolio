...
import leetcode from '../assets/gfg.png'
      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">GeeksForGeeks
</span>
            <span className="text font-bold">Problem solved:100+</span>
          </div>
          <div className="bottom">
            ...
            <div className="view-more">
              <a className="view-more-button" href='https://www.geeksforgeeks.org/user/adarshsharc3pj/'>View Profile</a>
...
const StyledWrapper = styled.div`
 ...
 .card {
    height: 100%;
    border-radius: 50px;
    background: linear-gradient(135deg, rgb(13, 98, 9) 30%, rgb(84, 137, 44) 100%);
